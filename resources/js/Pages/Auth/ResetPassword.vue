...
<template>
    <div class="flex min-h-screen items-center justify-center px-4">
        <div class="w-full max-w-sm">
            <h1 class="mb-6 text-lg font-bold text-brand-800">Nueva contraseña</h1>
            ...
            <div class="rounded-xl border border-line bg-white p-7 shadow-sm">
                <form class="flex flex-col gap-4" @submit.prevent="submit">
                    ...
                    <label class="flex flex-col gap-1.5">
                        <span class="text-xs font-semibold text-ink">Contraseña nueva</span>
                        <input
                    ...
                    <label class="flex flex-col gap-1.5">
                        <span class="text-xs font-semibold text-ink">Repítela</span>
                        <input
                    ...
                    <p
                        ...
                        :key="error"
                        class="text-xs font-medium text-impossible"
                    >
                        {{ error }}
                    </p>
